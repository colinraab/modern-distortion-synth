...
namespace Service
{
    ...
    PresetManager::PresetManager(AuxPort::ParameterMap* pM)
    {
    ...
    void PresetManager::savePreset(const juce::String& presetName)
    {
        ...
        auto xml = parameterMap->createXML();
    ...
    void PresetManager::loadPreset(const juce::String& presetName)
    {
        ...
        currentPreset.setValue(presetName);
        parameterMap->loadXML(*xmlDocument.getDocumentElement());
    }
